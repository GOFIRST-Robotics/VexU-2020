...
INCLUDE=$(foreach dir,$(INCDIR) $(EXTRA_INCDIR) $(LIB_INCDIR),-iquote"$(dir)")
...
.PHONY: all prepare clean quick

quick: prepare $(DEFAULT_BIN)

all: clean prepare $(DEFAULT_BIN)

prepare:
	@echo Preparing sources
	-$Dmkdir -p $(SRCDIR)
	-$Dmkdir -p $(INCDIR)
	-$Dcp -r $(BOT_SRCDIR)/* $(SRCDIR)
	-$Dcp -r $(LIB_SRCDIR)/* $(SRCDIR)
	-$Dcp -r $(BOT_INCDIR)/* $(INCDIR)
	-$Dcp -r $(LIB_INCDIR)/* $(INCDIR)
